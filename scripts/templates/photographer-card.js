function photographerTemplate(data) {
  ...
  function getUserCardDOM() {
    ...
    article.innerHTML =  `
     <a href="photographer.html?id=${id}" aria-label="aller vers la page de ${name}">
      <div class="article__img--rounded">
        <img src="${picture}" alt="" class="article__img" onload="checkImageSize(this, '${name}')">
      </div>
    ...
    // articleInfo.setAttribute(
    //   "aria-label",
    //   "information de la ou du photographe"
    // );
